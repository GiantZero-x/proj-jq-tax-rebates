            ...
            <section class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div data-gctable
                         ...
                         data-label="序号,角色名称,描述"
                         data-query=".queryForm"
                         data-check="true"
                         data-operate="2|修改||role?outer=roldetail&tp=update|1000px,3|删除|info|role?tp=del"
                         data-operateFilter="u,d"
                         data-field="id,display_name,description"
                         data-colWidth="70,100,120"
                    ></div>
                </div>
            </section>
        </section>
