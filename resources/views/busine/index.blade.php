            ...
            <section class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="pull-right">
                        <a href="#" class="btn btn-s-md btn-danger m-r-xs pull-right" data-id="0" data-type="2" data-api="busine?outer=busdetail&tp=call" data-outwidth="600px">新增项目</a>
                    </div>
                    <div data-gctable
                         data-url="/busine"
                         data-label="序号,公司,业务类型,合同类型"
                         data-query=".queryForm"
                         data-operate="2|修改||busine?outer=busdetail&tp=update|600px,3|删除|info|busine?tp=del"
                         data-operateFilter=""
