...
trait Search
{
    public function scopeSearchDate(Builder $query, string $column, ?string $start , ?string $end = null, $dateTime = false)
    {
        if (false !== $dateTime) {
    ...
    public function scopeSearchDateTime(Builder $query, string $column, ?string $start , ?string $end = null)
    {
        [$start, $end] = $this->trans($start, $end);
